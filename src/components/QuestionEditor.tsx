...
const INITIAL_QS: Question[] = [
  ...
  { id:"S9",  composite:"Setup / Admin",  module:"Setup",           weight:null, always:true,  type:"single",   label:"Household type",                                             options:["Lives alone","Nuclear family","Joint family","Female-headed household"],                                                                                                                      hint:"" },
  ...
  { id:"SM5", composite:"Setup / Admin",  module:"Researcher only", weight:null, always:true,  type:"single",   label:"Social category",                                            options:["SC","ST","OBC","General","Prefer not to say"],                                                                                                                                               hint:"From beneficiary records" },
  ...
  { id:"P6", composite:"Household Stability",  module:"Core",        weight:2, always:true,  type:"single",  label:"In the last 6 months, did she experience an unexpected financial shock?",                                                                    options:["Yes","No"],                                                                                                                                                                                                                   scores:{"Yes":0.0,"No":0.0},  hint:"Gate — triggers P7 if Yes. No direct score." },
  { id:"P7", composite:"Household Stability",  module:"Core",        weight:2, always:false, type:"single",  label:"Was she able to manage it without borrowing at high interest?",                                                                              options:["Yes, managed without borrowing","Yes, but had to borrow","No, could not manage it","Not applicable"],                                                                                                                        scores:{"Yes, managed without borrowing":1.0,"Yes, but had to borrow":0.4,"No, could not manage it":-0.2,"Not applicable":0.0},  hint:"Shown if P6 = Yes. Also feeds Debt & Credit Relief at weight 1." },
  { id:"P8", composite:"Household Stability",  module:"Core",        weight:2, always:true,  type:"single",  label:"Does she feel the DBT payment has reduced month-end financial pressure?",                                                                    options:["Yes, significantly","Yes, a little","No difference","Pressure has increased"],                                                                                                                                               scores:{"Yes, significantly":1.0,"Yes, a little":0.6,"No difference":0.0,"Pressure has increased":-0.2},  hint:"" },
  { id:"D1", composite:"Household Stability",  module:"Story Depth", weight:1, always:false, type:"open",    label:"Tell me about a specific time before this money came when she could not manage an expense. What happened?",                                   options:[],  hint:"Shown if P3 shows difficulty (positions 1–3). Depth boost +5 to Stability + Debt." },
  { id:"D2", composite:"Household Stability",  module:"Story Depth", weight:1, always:false, type:"open",    label:"Was there a specific month or moment when she felt things were different because of this payment?",                                           options:[],  hint:"Shown if P5 or P8 shows improvement." },
  ...
  { id:"P13", composite:"Financial Confidence", module:"Core",        weight:3, always:true,  type:"scale5", label:"On a scale of 1–5, how confident does she feel in managing her household's finances today?",        options:["1 — Not at all confident","2","3","4","5 — Very confident"],                                        scores:{"1":-0.2,"2":0.0,"3":0.5,"4":0.75,"5":1.0},                                                                                               hint:"Low confidence scores negative — signals disempowerment." },
  ...
  { id:"D4",  composite:"Financial Confidence", module:"Story Depth", weight:1, always:false, type:"open",   label:"How does it feel to know that a payment is coming on a fixed date?",                                options:[],  hint:"Shown if P13 ≥ 4 or P14/P15 positive. Depth boost +5." },

  // HOUSEHOLD AGENCY
  { id:"E1",  composite:"Household Agency", module:"Core",     weight:3, always:true,  type:"single", label:"Does the Ladki Bahin payment come directly into her own bank account?",                                  options:["Directly into my own account","Joint account I can access","My husband's account","Another family member's account"],  scores:{"Directly into my own account":1.0,"Joint account I can access":0.6,"My husband's account":0.0,"Another family member's account":0.0},  hint:"Primary structural signal. Most basic indicator of financial access." },
  { id:"E2",  composite:"Household Agency", module:"Core",     weight:3, always:true,  type:"single", label:"When this money arrives — who decides how it is spent?",                                                 options:["I decide","Jointly with my husband","Mostly my husband","My husband or family decides"],                                               scores:{"I decide":1.0,"Jointly with my husband":0.7,"Mostly my husband":0.0,"My husband or family decides":-0.2},                                  hint:"Negative when husband/family controls spending." },
  { id:"P15", composite:"Household Agency", module:"Core",     weight:2, always:true,  type:"single", label:"Does she feel she has more say in how the household money is spent since receiving this payment?",       options:["Yes, a lot more","Yes, a little more","No change","Less say than before"],                                                        scores:{"Yes, a lot more":1.0,"Yes, a little more":0.6,"No change":0.0,"Less say than before":-0.2},                                                hint:"" },
  ...
  { id:"A6c", composite:"Household Agency", module:"Adaptive", weight:2, always:false, type:"single", label:"Has her role in household financial decisions changed since receiving this money?",                       options:["Yes, I have much more say","Yes, a little more say","No change","Less say"],                                                             scores:{"Yes, I have much more say":1.0,"Yes, a little more say":0.6,"No change":0.0,"Less say":-0.2},                                              hint:"Shown if P15 positive. Max 2 agency follow-ups." },
  ...
  { id:"A4d", composite:"Livelihood & Enterprise", module:"Adaptive", weight:2, always:false, type:"single", label:"Does she plan to continue or expand this activity in the next 6 months?",                          options:["Yes, expand","Yes, continue at same level","Uncertain","No"],                                          scores:{"Yes, expand":1.0,"Yes, continue at same level":0.65,"Uncertain":0.3,"No":0.0},                          hint:"Max 2 livelihood follow-ups." },
  ...
  // NARRATIVE
  { id:"D6", composite:"Narrative", module:"Her Voice",  weight:null, always:true,  type:"open",   label:"If she were to explain to her neighbour what has changed since this money started coming — what would she say?",  options:[],  hint:"Always shown. Record exact language." },
  { id:"D7", composite:"Narrative", module:"Her Voice",  weight:null, always:true,  type:"open",   label:"If this payment stopped tomorrow — what is the first thing in her life that would be affected?",                  options:[],  hint:"Always shown. Reveals what matters most." },
